...
public class PowerCharger extends CustomRelic {
    ...
    public void onPlayerEndTurn()
    {
        ...
        {
            this.flash();
            AbstractDungeon.actionManager.addToTop(new GainBlockAction(AbstractDungeon.player, AbstractDungeon.player, (AbstractDungeon.player.maxOrbs- AbstractDungeon.player.filledOrbCount())));
