...
public class VoiceBox extends CustomRelic {
    ...
    private static final Texture OUTLINE = TextureLoader.getTexture(makeRelicOutlinePath("VoiceBox.png"));
    ...
    public void atBattleStart() {
        if (AbstractDungeon.getCurrRoom() instanceof MonsterRoomBoss) {
            AbstractDungeon.actionManager.addToBottom(new TalkAction(true, getBossTaunt(), 0.0F, 3.0F));
        } else if (AbstractDungeon.getCurrRoom() instanceof MonsterRoomElite) {
            AbstractDungeon.actionManager.addToBottom(new TalkAction(true, getEliteTaunt(), 0.0F, 3.0F));
        } else {
            AbstractDungeon.actionManager.addToBottom(new TalkAction(true, getIntroTaunt(), 0.0F, 3.0F));
        }
    }
    ...
    public void onUseCard(AbstractCard card, UseCardAction action) {
        switch (card.cardID) {
            case "Demon Form":
                AbstractDungeon.actionManager.addToBottom(new TalkAction(true, getDemonTaunt(), 0.0F, 3.0F));
                break;
            case "Shrug It Off":
                AbstractDungeon.actionManager.addToBottom(new TalkAction(true, getShrugTaunt(), 0.0F, 3.0F));
                break;
            case "Corruption":
                AbstractDungeon.actionManager.addToBottom(new TalkAction(true, getCorruptionTaunt(), 0.0F, 3.0F));
                break;
            case "Fiend Fire":
            case "Immolate":
                AbstractDungeon.actionManager.addToBottom(new TalkAction(true, getFlameTaunt(), 0.0F, 3.0F));
                break;
            case "Feed":
                AbstractDungeon.actionManager.addToBottom(new TalkAction(true, getFeedTaunt(), 0.0F, 3.0F));
                break;
            case "Wraith Form v2":
                AbstractDungeon.actionManager.addToBottom(new TalkAction(true, getWraithTaunt(), 0.0F, 3.0F));
                break;
            case "Terror":
                AbstractDungeon.actionManager.addToBottom(new TalkAction(true, getTerrorTaunt(), 0.0F, 3.0F));
                break;
            case "Caltrops":
                AbstractDungeon.actionManager.addToBottom(new TalkAction(true, getCaltropsTaunt(), 0.0F, 3.0F));
                break;
            case "Grand Finale":
                AbstractDungeon.actionManager.addToBottom(new TalkAction(true, getGrandFinaleTaunt(), 0.0F, 3.0F));
                break;
            case "vexMod:MidnightStrike":
                AbstractDungeon.actionManager.addToBottom(new TalkAction(true, getMidnightTaunt(), 0.0F, 3.0F));
                break;
            case "Distraction":
                AbstractDungeon.actionManager.addToBottom(new TalkAction(true, getDistractionTaunt(), 0.0F, 3.0F));
                break;
            case "Backstab":
                AbstractDungeon.actionManager.addToBottom(new TalkAction(true, getBackstabTaunt(), 0.0F, 3.0F));
                break;
            case "Hyperbeam":
                AbstractDungeon.actionManager.addToBottom(new TalkAction(true, getHyperbeamTaunt(), 0.0F, 3.0F));
                break;
            case "Echo Form":
                AbstractDungeon.actionManager.addToBottom(new TalkAction(true, getEchoTaunt(), 0.0F, 3.0F));
                break;
            case "BootSequence":
            case "Reboot":
                AbstractDungeon.actionManager.addToBottom(new TalkAction(true, getBootTaunt(), 0.0F, 3.0F));
                break;
            case "White Noise":
                AbstractDungeon.actionManager.addToBottom(new TalkAction(true, getNoiseTaunt(), 0.0F, 3.0F));
                break;
    ...
    private String getAttackTaunt(UseCardAction action) {
        ...
        if (taunts.size()<1)
        {
            ...
            taunts.add(DESCRIPTIONS[198]);
            taunts.add(DESCRIPTIONS[199]);
            taunts.add(DESCRIPTIONS[200]);
            taunts.add(DESCRIPTIONS[201]);
            taunts.add(DESCRIPTIONS[202]);
            taunts.add(DESCRIPTIONS[203]);
            taunts.add(DESCRIPTIONS[204]);
        }
        return taunts.get(MathUtils.random(taunts.size() - 1));
    }
