...
public class NewsTicker extends CustomRelic implements ClickableRelic { // You must implement things you want to use from StSlib
    /*
    ...
    // ID, images, text.
    public static final String ID = VexMod.makeID("NewsTicker");

    private static final Texture IMG = TextureLoader.getTexture(makeRelicPath("NewsTicker.png"));
    private static final Texture OUTLINE = TextureLoader.getTexture(makeRelicOutlinePath("NewsTicker.png"));
            ...
            Thread t = new Thread() {
                public void run() {
                    ...
                    try {
                        ...
                        AbstractDungeon.actionManager.addToBottom(new RelicTalkAction(AbstractDungeon.player.getRelic(NewsTicker.ID), statuses.get(0).getText(), 0.0F, 3.5F));
