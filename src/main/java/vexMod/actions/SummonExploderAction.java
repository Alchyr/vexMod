...
public class SummonExploderAction extends AbstractGameAction {
    ...
    public void update() {
        ...
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(m, m, new ExplosivePower(m, 3)));
