...
import vexMod.relics.HealthChanger;
    ...
    private void updateTargetMode() {
        ...
        if (InputHelper.justClickedLeft) {
            ...
            if (this.hoveredCreature != null && this.hoveredCreature != AbstractDungeon.player) {
                if (r.relicId.equals(HealthChanger.ID)) {
                    float playerPlace = AbstractDungeon.player.drawX;
                    float playerHeight = AbstractDungeon.player.drawY;
                    float playerDialogPlace = AbstractDungeon.player.dialogX;
                    float playerDialogHeight = AbstractDungeon.player.dialogY;
                    AbstractDungeon.player.dialogX += (this.hoveredCreature.drawX - AbstractDungeon.player.drawX);
                    AbstractDungeon.player.dialogY += (this.hoveredCreature.drawY - AbstractDungeon.player.drawY);
                    AbstractDungeon.player.drawX = this.hoveredCreature.drawX;
                    AbstractDungeon.player.drawY = this.hoveredCreature.drawY;
                    this.hoveredCreature.drawX = playerPlace;
                    this.hoveredCreature.drawY = playerHeight;
                    this.hoveredCreature.dialogX = playerDialogPlace;
                    this.hoveredCreature.dialogY = playerDialogHeight;
