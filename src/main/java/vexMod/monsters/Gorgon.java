...
public class Gorgon extends AbstractMonster {
    public static final String ID = VexMod.makeID("Gorgon"); // Makes the monster ID based on your mod's ID. For example: theDefault:BaseMonster
    ...
    private static final int A_7_HP_MIN = 162; // HP moves up at Ascension 7.
    private static final int A_7_HP_MAX = 183;
    private static final float HB_X = 0.0F;
    private static final float HB_Y = 0.0F;
    private static final float HB_W = 150.0F;
    private static final float HB_H = 150.0F;
    private static final int ATTACKVOID_DAMAGE = 12;
    private static final int A_2_ATTACKVOID_DAMAGE = 15;
    private static final int DEBUFF_AMT = 2;
    private static final int A_17_DEBUFF_AMT = 4;
    ...
    public Gorgon(float x, float y) {
        super(NAME, "Gorgon", 25, HB_X, HB_Y, HB_W, HB_H, "vexModResources/images/monsters/hex.png", x, y); // Initializes the monster.
