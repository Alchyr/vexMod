...
public class Octiver extends AbstractMonster {
    public static final String ID = VexMod.makeID("Octiver"); // Makes the monster ID based on your mod's ID. For example: theDefault:BaseMonster
    ...
    private static final int HP_MIN = 111; // Always good to back up your health and move values.
    private static final int HP_MAX = 123;
    private static final int A_7_HP_MIN = 125; // HP moves up at Ascension 7.
    private static final int A_7_HP_MAX = 150;
    private static final float HB_X = 0.0F;
    private static final float HB_Y = 0.0F;
    private static final float HB_W = 150.0F;
    private static final float HB_H = 150.0F;
    private static final int ATTACKBLOCK_BLOCK = 12;
    private static final int A_2_ATTACKBLOCK_BLOCK = 15;
    private static final int ATTACKBLOCK_DAMAGE = 12;
    ...
    public Octiver(float x, float y) {
        super(NAME, "Octiver", 25, HB_X, HB_Y, HB_W, HB_H, "vexModResources/images/monsters/hex.png", x, y); // Initializes the monster.
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            ...
            case 3:
                ...
                AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(AbstractDungeon.player, this, new InkPower(AbstractDungeon.player, this, drawDownAmt), drawDownAmt));
        }
