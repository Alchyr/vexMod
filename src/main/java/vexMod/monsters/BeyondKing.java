...
public class BeyondKing extends AbstractMonster {
    ...
    private static final int HP_MIN = 1000; // Always good to back up your health and move values.
    private static final int HP_MAX = 1000;
    private static final int A_7_HP_MIN = 2000; // HP moves up at Ascension 7.
    private static final int A_7_HP_MAX = 2000;
    private static final float HB_X = 0.0F;
    private static final float HB_Y = 0.0F;
    private static final float HB_W = 276.0F;
    private static final float HB_H = 280.0F;
    private static final int BLOCK_GAIN = 17;
    ...
    private AbstractPower getRandomLetterCurse() {
        AbstractPower CursePower;
        ArrayList<AbstractPower> curseList = new ArrayList<>();
        curseList.add(new CursedAPower(AbstractDungeon.player, this, 1));
        curseList.add(new CursedBPower(AbstractDungeon.player, this, 1));
        curseList.add(new CursedCPower(AbstractDungeon.player, this, 1));
        curseList.add(new CursedDPower(AbstractDungeon.player, this, 1));
        curseList.add(new CursedEPower(AbstractDungeon.player, this, 1));
        curseList.add(new CursedFPower(AbstractDungeon.player, this, 1));
        curseList.add(new CursedGPower(AbstractDungeon.player, this, 1));
        curseList.add(new CursedHPower(AbstractDungeon.player, this, 1));
        curseList.add(new CursedIPower(AbstractDungeon.player, this, 1));
        curseList.add(new CursedJPower(AbstractDungeon.player, this, 1));
        curseList.add(new CursedKPower(AbstractDungeon.player, this, 1));
        curseList.add(new CursedLPower(AbstractDungeon.player, this, 1));
        curseList.add(new CursedMPower(AbstractDungeon.player, this, 1));
        curseList.add(new CursedNPower(AbstractDungeon.player, this, 1));
        curseList.add(new CursedOPower(AbstractDungeon.player, this, 1));
        curseList.add(new CursedPPower(AbstractDungeon.player, this, 1));
        curseList.add(new CursedQPower(AbstractDungeon.player, this, 1));
        curseList.add(new CursedRPower(AbstractDungeon.player, this, 1));
        curseList.add(new CursedSPower(AbstractDungeon.player, this, 1));
        curseList.add(new CursedTPower(AbstractDungeon.player, this, 1));
        curseList.add(new CursedUPower(AbstractDungeon.player, this, 1));
        curseList.add(new CursedVPower(AbstractDungeon.player, this, 1));
        curseList.add(new CursedWPower(AbstractDungeon.player, this, 1));
        curseList.add(new CursedXPower(AbstractDungeon.player, this, 1));
        curseList.add(new CursedYPower(AbstractDungeon.player, this, 1));
        curseList.add(new CursedZPower(AbstractDungeon.player, this, 1));
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            case 1:
                AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(AbstractDungeon.player, this, getRandomLetterCurse(), 1));
                AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(AbstractDungeon.player, this, getRandomLetterCurse(), 1));
                break;
            case 2:
                AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(AbstractDungeon.player, this, getRandomLetterCurse(), 1));
