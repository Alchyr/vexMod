...
public class StarBlast extends AbstractDefaultCard {
    ...
    public static final String ID = VexMod.makeID("StarBlast"); // VexMod.makeID("${NAME}");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("StarBlast.png");// "public static final String IMG = makeCardPath("${NAME}.png");
    ...
    public StarBlast() { // public ${NAME}() - This one and the one right under the imports are the most important ones, don't forget them
