...
public class Taunt extends AbstractDefaultCard {
    ...
    public static final String ID = VexMod.makeID("Taunt"); // VexMod.makeID("${NAME}");
    ...
    public Taunt() { // public ${NAME}() - This one and the one right under the imports are the most important ones, don't forget them
