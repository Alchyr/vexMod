...
public class DefaultCommonAttack extends CustomCard {
    ...
    public static final String ID = VexMod.makeID("DefaultCommonAttack");
    ...
    // The list of all of them can be found in the main VexMod.java file in the
    ...
    // Go check out DefaultAttackWithVariable and VexMod.variable.DefaultCustomVariable
