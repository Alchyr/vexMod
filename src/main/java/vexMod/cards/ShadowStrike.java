...
public class ShadowStrike extends AbstractDefaultCard {
    ...
    public static final String ID = VexMod.makeID("ShadowStrike"); // VexMod.makeID("${NAME}");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("ShadowStrike.png");// "public static final String IMG = makeCardPath("${NAME}.png");
    ...
    public ShadowStrike() { // public ${NAME}() - This one and the one right under the imports are the most important ones, don't forget them
