...
public class CleverClash extends AbstractDefaultCard {

    // TEXT DECLARATION

    public static final String ID = VexMod.makeID("CleverClash"); // VexMod.makeID("${NAME}");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("CleverClash.png");// "public static final String IMG = makeCardPath("${NAME}.png");
    ...
    public CleverClash() { // public ${NAME}() - This one and the one right under the imports are the most important ones, don't forget them
