...
import vexMod.powers.LoseFocusPower;

import static vexMod.VexMod.makeCardPath;

// public class ${NAME} extends AbstractDefaultCard
public class ShockKick extends AbstractDefaultCard {

    // TEXT DECLARATION

    public static final String ID = VexMod.makeID("ShockKick"); // VexMod.makeID("${NAME}");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("ShockKick.png");// "public static final String IMG = makeCardPath("${NAME}.png");
