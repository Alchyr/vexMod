...
public class CurseBlast extends AbstractDefaultCard {
    ...
    public static final String ID = VexMod.makeID("CurseBlast"); // VexMod.makeID("${NAME}");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("CurseBlast.png");// "public static final String IMG = makeCardPath("${NAME}.png");
