...
public class ChargeBeam extends AbstractDefaultCard {


    // TEXT DECLARATION

    public static final String ID = VexMod.makeID("ChargeBeam"); // VexMod.makeID("${NAME}");
    ...
    public ChargeBeam() { // public ${NAME}() - This one and the one right under the imports are the most important ones, don't forget them
