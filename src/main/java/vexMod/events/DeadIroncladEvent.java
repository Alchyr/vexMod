...
public class DeadIroncladEvent extends AbstractImageEvent {
    ...
    public DeadIroncladEvent() {
        ...
        imageEventText.setDialogOption(OPTIONS[1]); // Help Body: Get a card from the Ironclad class.
        if (this.canPurge) {
            ...
            case 0: // While you are on screen number 0 (The starting screen)
                switch (i) {
                    ...
                    case 1: // If you press button the second button (Button at index 1), in this case: Ease
                        ...
                        AbstractCard card1 = CardLibrary.getRandomColorSpecificCard(AbstractCard.CardColor.RED, AbstractDungeon.cardRandomRng);
                        AbstractCard card2 = CardLibrary.getRandomColorSpecificCard(AbstractCard.CardColor.RED, AbstractDungeon.cardRandomRng);
                        AbstractCard card3 = CardLibrary.getRandomColorSpecificCard(AbstractCard.CardColor.RED, AbstractDungeon.cardRandomRng);
                        RewardItem reward = new RewardItem();
                        AbstractCard card4 = CardLibrary.getRandomColorSpecificCard(AbstractCard.CardColor.RED, AbstractDungeon.cardRandomRng);
                        AbstractCard card5 = CardLibrary.getRandomColorSpecificCard(AbstractCard.CardColor.RED, AbstractDungeon.cardRandomRng);
                        AbstractCard card6 = CardLibrary.getRandomColorSpecificCard(AbstractCard.CardColor.RED, AbstractDungeon.cardRandomRng);
                        RewardItem reward2 = new RewardItem();
                        AbstractCard card7 = CardLibrary.getRandomColorSpecificCard(AbstractCard.CardColor.RED, AbstractDungeon.cardRandomRng);
                        AbstractCard card8 = CardLibrary.getRandomColorSpecificCard(AbstractCard.CardColor.RED, AbstractDungeon.cardRandomRng);
                        AbstractCard card9 = CardLibrary.getRandomColorSpecificCard(AbstractCard.CardColor.RED, AbstractDungeon.cardRandomRng);
