...
public class DeadSilentEvent extends AbstractImageEvent {


    public static final String ID = VexMod.makeID("DeadSilentEvent");
    public static final String IMG = makeEventPath("DeadSilentEvent.png");
