            ...
            case 0: // While you are on screen number 0 (The starting screen)
                switch (i) {
                    ...
                    case 1: // If you press button the second button (Button at index 1), in this case: Ease
                        ...
                        AbstractCard card1 = getRandomRewardColorSpecificCard(AbstractCard.CardColor.BLUE).makeCopy();
                        AbstractCard card2 = getRandomRewardColorSpecificCard(AbstractCard.CardColor.BLUE).makeCopy();
                        AbstractCard card3 = getRandomRewardColorSpecificCard(AbstractCard.CardColor.BLUE).makeCopy();
                        RewardItem reward = new RewardItem();
                        AbstractCard card4 = getRandomRewardColorSpecificCard(AbstractCard.CardColor.BLUE).makeCopy();
                        AbstractCard card5 = getRandomRewardColorSpecificCard(AbstractCard.CardColor.BLUE).makeCopy();
                        AbstractCard card6 = getRandomRewardColorSpecificCard(AbstractCard.CardColor.BLUE).makeCopy();
                        RewardItem reward2 = new RewardItem();
                        AbstractCard card7 = getRandomRewardColorSpecificCard(AbstractCard.CardColor.BLUE).makeCopy();
                        AbstractCard card8 = getRandomRewardColorSpecificCard(AbstractCard.CardColor.BLUE).makeCopy();
                        AbstractCard card9 = getRandomRewardColorSpecificCard(AbstractCard.CardColor.BLUE).makeCopy();
