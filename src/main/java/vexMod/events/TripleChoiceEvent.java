...
public class TripleChoiceEvent extends AbstractImageEvent {
    ...
    public TripleChoiceEvent() {
        ...
        imageEventText.setDialogOption(OPTIONS[0]); // Strength - Gain an Infernal Blade+.
        imageEventText.setDialogOption(OPTIONS[1]); // Skill - Gain a Distraction+.
        imageEventText.setDialogOption(OPTIONS[2]); // Power - Gain a White Noise+.
    }
