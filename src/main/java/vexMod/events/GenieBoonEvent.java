            ...
            case 0: // While you are on screen number 0 (The starting screen)
                switch (i) {
                    case 0: // If you press button the first button (Button at index 0), in this case: Inspiration.
                        ...
                        possibleRelics.add(RelicLibrary.getRelic(PitifulBounty.ID));
                        possibleRelics.add(RelicLibrary.getRelic(PukeWorm.ID));
                        possibleRelics.add(RelicLibrary.getRelic(HappyDrink.ID));
                    ...
                    case 1: // If you press button the second button (Button at index 1), in this case: Ease
                        ...
                        AbstractDungeon.getCurrRoom().addRelicToRewards(new ShortStop());
                    ...
                    case 2: // If you press button the third button (Button at index 2), in this case: Acceptance
                        ...
                        AbstractDungeon.getCurrRoom().rewards.clear();
                        AbstractDungeon.getCurrRoom().addRelicToRewards(new SpinShoes());
                        AbstractDungeon.getCurrRoom().phase = AbstractRoom.RoomPhase.COMPLETE;
                        AbstractDungeon.combatRewardScreen.open();
